...
CFLAGS = ${CWARN} ${OPT} ${MF} -march=core2 -mfpmath=sse -mssse3 -ggdb -fno-strict-aliasing -fno-strict-overflow -fwrapv -fpermissive ${PROFC}
...
KPHPOBJS	=	${OBJ}/KPHP/runtime/allocator.o ${OBJ}/KPHP/runtime/array_functions.o ${OBJ}/KPHP/runtime/bcmath.o ${OBJ}/KPHP/runtime/datetime.o ${OBJ}/KPHP/runtime/drivers.o ${OBJ}/KPHP/runtime/exception.o ${OBJ}/KPHP/runtime/files.o ${OBJ}/KPHP/runtime/interface.o ${OBJ}/KPHP/runtime/math_functions.o ${OBJ}/KPHP/runtime/mbstring.o ${OBJ}/KPHP/runtime/misc.o ${OBJ}/KPHP/runtime/openssl.o ${OBJ}/KPHP/runtime/regexp.o ${OBJ}/KPHP/runtime/rpc.o ${OBJ}/KPHP/runtime/string_functions.o ${OBJ}/KPHP/runtime/url.o ${OBJ}/KPHP/runtime/zlib.o ${OBJ}/KPHP/runtime/gost_hash.o ${OBJ}/KPHP/runtime/curl.o ${OBJ}/KPHP/runtime/couchbase.o
...
OBJECTS_CXX	= \
    ...
    ${OBJ}/KPHP/runtime/zlib.o ${OBJ}/KPHP/runtime/gost_hash.o ${OBJ}/KPHP/runtime/curl.o ${OBJ}/KPHP/runtime/couchbase.o \
